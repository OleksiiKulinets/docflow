...
const NodeUiUk = (() => {
  ...
  const strings = {
    ...
    variantPreviewLabel: "Варіанти умови",
    variantAutoCreated: "Варіанти прив’язано до «{label}»",
    variantUnsupportedField: "Ця умова не підходить для варіантів (потрібно Так/Ні або список).",
    changeVariantGroupCondition: "Змінити умову групи",
    variantFieldTypeMismatch: "Нова умова має бути того ж типу (Так/Ні або список варіантів).",
    ...
    deleteSectionTip: "Видалити цей розділ і все його наповнення з правил",
    deleteMarker: "Видалити маркер",
    deleteMarkerTip: "Видалити цей маркер і все піддерево",
    deleteVariantGroup: "Видалити групу",
    deleteVariantGroupLink: "Видалити групу варіантів",
    deleteVariantGroupTip: "Видалити всю групу варіантів (Так/Ні) з правил",
    variantsNavLabel: "Варіанти розділу",
    documentConditionLabel: "Умова документа:",
    ...
    selectSubVariantForContentHint: "Оберіть вкладку варіанту зверху — далі додайте зміст у блоці «Зміст».",
    ...
    assignedBlocks: "Прив’язано",
    blocksEmpty: "Ще немає блоків. Оберіть режим «Блоки», «Область» або «Текст».",
    blocksEmptyShort: "Поки нічого не прив’язано — оберіть режим вище.",
    assignModeLead: "Як додати текст з документа?",
    assignModeBlockDesc: "Клік по абзацу",
    assignModeMarqueeDesc: "Протягнути мишею",
    assignModeTextDesc: "Виділити фрагмент",
    addBlockFromListTip: "Прив’язати цей блок до вузла",
    docBlocksHint: "Альтернатива — обрати блок зі списку замість кліку в документі.",
    addFromDoc: "Додати з документа",
    assignToolGroupAria: "Режим додавання з документа",
    assignToolBlock: "Блоки",
    assignToolBlockTip: "Клік по абзацу — додати або прибрати цілий блок. Ctrl+клік по таблиці — уся таблиця.",
    assignToolMarquee: "Область",
    assignToolMarqueeTip: "Затисніть ЛКМ і протягніть — виділити кілька блоків.",
    assignToolText: "Текст",
    assignToolTextTip: "Виділіть слова або букви в документі, потім «Додати виділення».",
    assignHintOff: "Оберіть один із режимів вище.",
    assignHintBlock: "Клік — цілий блок. Повторний клік — прибрати.",
    assignHintMarquee: "Протягніть мишею по документу, щоб виділити блоки.",
    assignHintText: "Виділіть потрібний фрагмент тексту і натисніть «Додати виділення».",
    assignStatusBlock: "Режим блоків — клікайте по абзацах",
    assignStatusMarquee: "Режим області — протягніть мишею",
    assignStatusText: "Режим тексту — виділіть фрагмент",
    assignStatusOff: "Режим додавання вимкнено",
    doneAssignTip: "Вимкнути режим додавання",
    addTableBlocks: "Додати всю таблицю",
    addTableBlocksLabel: "Таблиця",
    addTableBlocksMeta: "блоків",
    doneAssign: "Готово",
    ...
    textSpanBadge: "фрагмент",
    addTextSpan: "Додати виділення",
    addTextSpanTip: "Спочатку виділіть частину тексту в документі",
    showMoreBlocks: "Ще {n}…",
    showLessBlocks: "Згорнути список",
    filterBlocks: "Пошук блоків",
    filterBlocksPlaceholder: "Пошук за текстом або ID…",
    noBlocksMatchFilter: "Немає блоків за цим запитом.",
    ...
    emptyAddDocBlockHint: "Оберіть режим вище — блоки, область або текст — і працюйте з документом праворуч.",
    ...
    templateGuide2: "У блоці «Зміст» оберіть режим (блоки, область або текст) і позначте текст у документі.",
    templateGuide3: "Перевірте зліва в панелі «Умови».",
    templateGuideDismiss: "Зрозуміло",
    selectVariantHint: "Оберіть вкладку варіанту зверху для редагування.",
  ...
  function contextHelp(node, model) {
    ...
    if (!fields.length) {
      return {
        ...
        body: "«+ Умова» зверху. Потім оберіть її в «Яку умову використати» — варіанти створяться автоматично.",
      };
    }
    ...
    if (canContent && !NodeModel.getBlockIds(node).length) {
      return {
        ...
        body: "У блоці «Зміст» оберіть режим: блоки (клік), область (протягнути) або текст (виділити фрагмент).",
      };
    }
  ...
  function workflowGuide(model) {
    ...
    const steps = hasFields
        ? [
          ...
          "Оберіть розділ → «Яку умову використати» — варіанти підвантажаться автоматично.",
        ...
        : [
          ...
          "«+ Розділ» — підпункт.",
          "Оберіть розділ → оберіть умову — варіанти з’являться одразу.",
